...
import { X, ShieldCheck, CheckCircle, Hammer, TrendingUp, Euro, Sun, Lightbulb, Palette, Home, Zap, Blinds, Sparkles } from 'lucide-react';
                ...
                >
                    ...
                    <div className="bg-slate-900 text-white pt-8 pb-6 px-8 shrink-0 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-2xl md:text-3xl font-bold leading-tight mb-2">Extensions & Vérandas</h3>
                            ...
                            <p className="text-slate-300 text-sm mt-4 leading-relaxed max-w-lg">
                                Ajoutez une véritable pièce à vivre à votre maison. Une extension véranda coûte moins cher qu'une construction traditionnelle tout en augmentant significativement la valeur de votre patrimoine.
                            </p>
                        </div>
                    ...
                    <div className="px-8 py-6 overflow-y-auto space-y-8 custom-scrollbar">
                        ...
                        <h4 className="font-bold text-slate-900 text-lg -mb-2">Pourquoi une Véranda SARANGE ?</h4>
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="bg-green-50 p-4 rounded-xl border border-green-100 flex items-start">
                                ...
                                <span className="text-sm text-slate-700 font-medium">Plus-value immobilière immédiate : Créez des m² habitables supplémentaires</span>
                            </div>
                            <div className="bg-green-50 p-4 rounded-xl border border-green-100 flex items-start">
                                <Euro className="text-green-600 mr-3 shrink-0" size={20} />
                                <span className="text-sm text-slate-700 font-medium">Alternative économique : Budget maîtrisé par rapport à une extension maçonnerie</span>
                            </div>
                            <div className="bg-green-50 p-4 rounded-xl border border-green-100 flex items-start">
                                <Sun className="text-orange-500 mr-3 shrink-0" size={20} />
                                <span className="text-sm text-slate-700 font-medium">Lumière & Bien-être : Une connexion unique avec votre jardin, été comme hiver</span>
                            </div>
                            <div className="bg-green-50 p-4 rounded-xl border border-green-100 flex items-start">
                                <Home className="text-blue-500 mr-3 shrink-0" size={20} />
                                <span className="text-sm text-slate-700 font-medium">Isolation RE2020 : Pièce chauffée et habitable toute l'année</span>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-center group">
                                    ...
                                    <span className="text-slate-700 font-medium">Structure 100% Aluminium Schüco à rupture de pont thermique</span>
                                </li>
                                <li className="flex items-center group">
                                    <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mr-3 shrink-0 group-hover:bg-blue-100 transition-colors">
                                        <CheckCircle size={14} className="text-blue-500" />
                                    </div>
                                    <span className="text-slate-700 font-medium">Finesse des profils pour un clair de jour maximal</span>
                                </li>
                                <li className="flex items-center group">
                                    <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mr-3 shrink-0 group-hover:bg-blue-100 transition-colors">
                                        <CheckCircle size={14} className="text-blue-500" />
                                    </div>
                                    <span className="text-slate-700 font-medium">Design sur-mesure : Toiture plate, Victorienne, ou pente classique</span>
                                </li>
                                <li className="flex items-center group">
                                    <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mr-3 shrink-0 group-hover:bg-blue-100 transition-colors">
                                        <Palette size={14} className="text-blue-500" />
                                    </div>
                                    <span className="text-slate-700 font-medium">Toutes les couleurs possibles (Bi-coloration, texturé, sablé...)</span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-blue-50/50 rounded-2xl p-6 border border-blue-100">
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start group">
                                    ...
                                    <div>
                                        <span className="text-slate-700 font-semibold">Toiture Climalux & Phonique :</span>
                                        <span className="text-slate-600"> Panneaux isolants haute densité avec traitement acoustique pour réduire considérablement le bruit de la pluie et de la grêle.</span>
                                    </div>
                                </li>
                                <li className="flex items-start group">
                                    ...
                                    <div>
                                        <span className="text-slate-700 font-semibold">Vitrage "4 Saisons" (Contrôle Solaire) :</span>
                                        <span className="text-slate-600"> Technologie intelligente qui rejette jusqu'à 80% de la chaleur en été tout en conservant les calories en hiver (Anti-effet de serre).</span>
                                    </div>
                                </li>
                                <li className="flex items-start group">
                                    ...
                                    <div>
                                        <span className="text-slate-700 font-semibold">Sécurité Renforcée (Feuilleté) :</span>
                                        <span className="text-slate-600"> Vitrage feuilleté de sécurité (type 44.2) obligatoire en toiture (protection des personnes) et retardateur d'effraction en façade.</span>
                                    </div>
                                </li>
                                <li className="flex items-start group">
                                    ...
                                    <div>
                                        ...
                                        <span className="text-slate-600"> Option vitrage Auto-nettoyant (Bioclean) disponible pour limiter le nettoyage des zones difficiles d'accès.</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-slate-50 rounded-2xl p-5 flex items-start border border-slate-100">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 leading-relaxed">
                                    Nos équipes spécialisées assurent une réalisation sur-mesure, de l'étude technique à la pose finale, pour garantir la pérennité de votre extension.
                                </p>
                            </div>
                        </div>
                    </div>
