...
const ContactBlock = ({ city, phoneLink }) => (
    // ✅ MODIFICATION : bg-slate-50 pour matcher le gris du formulaire
        ...
        <div className="container mx-auto px-4 max-w-7xl">
            ...
            <div className="text-center mb-10 md:mb-16">
                ...
                <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-4 uppercase tracking-tight leading-none">
                    Votre Projet sur {city} et environs
                </h2>
                <p className="text-lg md:text-xl text-slate-500 max-w-2xl mx-auto font-medium">
                    Besoin d'un chiffrage précis ? Discutez en direct avec le fabricant.
                </p>
            </div>
            ...
            <div className="grid lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-7 xl:col-span-8">
                    {/* Le formulaire a déjà son propre fond, il se fondra dans le bg-slate-50 de la section */}
                    <ContactForm />
                </div>

                {/* --- COLONNE DROITE : INFOS & ATELIER (5 cols) --- */}
                <aside className="lg:col-span-5 xl:col-span-4 space-y-6 sticky top-24">

                    {/* ✅ CARTE CLIQUABLE (Lance l'itinéraire) */}
                    <a
                    ...
                    >
                        ...
                        <div className="relative h-48 rounded-t-[20px] overflow-hidden bg-slate-200">
                            <iframe
                                ...
                                width="100%"
                                height="100%"
                                style={{ border: 0, pointerEvents: 'none' }} // Pointer events none pour laisser le clic au lien <a>
                                allowFullScreen=""
                                loading="lazy"
                            ...
                            <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                <span className="bg-white text-slate-900 font-bold px-4 py-2 rounded-full flex items-center gap-2 shadow-xl transform scale-90 group-hover:scale-100 transition-transform">
                                    <Navigation size={16} className="text-orange-500" /> Lancer l'itinéraire
                                </span>
                            </div>
                                ...
                                <div className="flex items-start gap-4 pt-4 border-t border-slate-100">
                                    ...
                                    <div className="text-sm w-full">
                                        ...
                                        <div className="grid grid-cols-2 gap-x-2 text-slate-600 text-xs">
                                            ...
                                            <span>Sam - Dim :</span>
                                            <span className="font-bold text-red-500 text-right">Fermé</span>
                                        </div>
                                    </div>
                                </div>
                            </address>
                    ...
                    <div className="bg-slate-900 rounded-3xl p-6 text-white shadow-xl">
                        ...
                        <ul className="space-y-3 text-sm text-slate-300">
                            <li className="flex items-center gap-3">
                                ...
                                <span>Fabricant Local (Atelier 77)</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <CheckCircle2 size={18} className="text-green-400 shrink-0" />
                                <span>Équipes de pose internes</span>
                            </li>
                            <li className="flex items-center gap-3">
                                <CheckCircle2 size={18} className="text-green-400 shrink-0" />
                                <span>RGE Qualibat & Décennale</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    >
                        <div className="flex items-center gap-4">
                            ...
                            <div className="text-left">
                                <p className="text-xs text-orange-100 font-bold uppercase tracking-wider">Une urgence ?</p>
