...
const VoletSection = () => {
    ...
    return (
        <section id="volets" className="py-16 bg-secondary-50 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 max-w-7xl relative z-10">
                ...
                <div className="text-center mb-10">
                    ...
                    <p className="text-lg md:text-xl text-secondary-600 max-w-3xl mx-auto">
                        ...
                        </span> pour toute commande avec fenêtres
                    </p>
                </div>
            ...
            <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-center mb-0.5">
                        <span className={`font-bold text-base ${isSelected ? 'text-secondary-900' : 'text-secondary-700'}`}>
                            {name}
                        </span>
                        {badge && (
                            <span className={`${badgeColor} text-white text-[10px] px-2 py-0.5 rounded-full font-bold shadow-sm uppercase tracking-wider ml-2`}>
                                {badge}
                            </span>
                        )}
                    </div>
                    ...
                    `}>
                        <ul className="min-h-0 space-y-1.5">
                            {features.map((feat, i) => (
                                <li key={i} className="flex items-start gap-2 text-xs text-secondary-700 font-medium">
