        ...
        <section id="fabrication" className="py-24 bg-slate-900 text-white">
            <div className="container mx-auto px-4">
                ...
                <p className="text-center text-xl text-slate-300 mb-16 max-w-3xl mx-auto">
                    Atelier de fabrication à <strong className="text-white">Combs-la-Ville (77)</strong>. De la prise de cotes à la pose finale,
                    nous maîtrisons l'intégralité du process.
                </p>
