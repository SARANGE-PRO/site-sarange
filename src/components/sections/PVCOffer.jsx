...
const PVCOffer = ({ onOpenAides }) => {
  ...
  // Correction des clés d'images selon constants.js
  const WINDOW_IMAGES = [
    ...
    { id: 'coulissant', image: IMAGES.pvc_coulissant, tabKey: 'coulissant' }, // Changed from pvc_coulissant_new
  ...
  const TABS = {
    fenetre: {
      id: 'fenetre',
      label: 'Fenêtre',
      image: IMAGES.pvc, // Changed from IMAGES.pvc_fenetre
    ...
    porte_fenetre: {
      id: 'porte_fenetre',
      label: 'Porte-Fenêtre',
      image: IMAGES.pvc_porte_fenetre_2vantaux, // Changed from IMAGES.pvc_pf2vt
    ...
    coulissant: {
      id: 'coulissant',
      label: 'Coulissant',
      image: IMAGES.pvc_coulissant, // Changed from IMAGES.pvc_coulissant_new
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setCurrentImageIndex(current => {
        ...
        // Note: We deliberately don't set config here to avoid too much jump spread, 
        // OR we can sync it. The user code synced it:
  ...
  }, [isAutoPlaying, isHovering]); // WINDOW_IMAGES and TABS are constant-like enough or check dependencies if they change
  ...
  // Scroll vers contact avec pré-remplissage
