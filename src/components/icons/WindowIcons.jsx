...
export const WindowIcons = {
    OneLeaf: ({ selected }) => (
        <svg viewBox="0 0 100 100" className={`w-12 h-12 ${selected ? 'stroke-orange-500' : 'stroke-slate-400'}`} fill="none" strokeWidth="2">
            <rect x="10" y="10" width="80" height="80" rx="2" className={selected ? 'fill-orange-50' : 'fill-white'} />
    ...
    FrenchDoor: ({ selected }) => (
        <svg viewBox="0 0 100 100" className={`w-12 h-12 ${selected ? 'stroke-orange-500' : 'stroke-slate-400'}`} fill="none" strokeWidth="2">
            <rect x="20" y="5" width="60" height="90" rx="2" className={selected ? 'fill-orange-50' : 'fill-white'} />
    ...
    Sliding: ({ selected }) => (
        <svg viewBox="0 0 100 100" className={`w-12 h-12 ${selected ? 'stroke-orange-500' : 'stroke-slate-400'}`} fill="none" strokeWidth="2">
            <rect x="5" y="20" width="90" height="60" rx="2" className={selected ? 'fill-orange-50' : 'fill-white'} />
    ...
    Composite: ({ selected }) => (
        <svg viewBox="0 0 100 100" className={`w-12 h-12 ${selected ? 'stroke-orange-500' : 'stroke-slate-400'}`} fill="none" strokeWidth="2">
            <rect x="5" y="10" width="90" height="80" rx="2" className={selected ? 'fill-orange-50' : 'fill-white'} />
