        ...
        >
          ...
          <div className="bg-slate-900 text-white pt-8 pb-6 px-8 shrink-0 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-2xl md:text-3xl font-bold leading-tight mb-2">
                Fenêtres & Coulissants PVC
              </h3>
              <p className="text-blue-200 text-lg font-medium">
                Performance, confort et durabilité
              </p>

              <p className="text-slate-300 text-sm mt-4 leading-relaxed max-w-lg">
                Les fenêtres et coulissants PVC SARANGE offrent un excellent équilibre entre
                performance thermique, confort acoustique et budget maîtrisé, pour la rénovation
                comme pour le remplacement de vos menuiseries.
              </p>
            </div>
          ...
          <div className="px-8 py-6 overflow-y-auto space-y-8 custom-scrollbar">
            ...
            <h4 className="font-bold text-slate-900 text-lg -mb-2">
              Pourquoi choisir le PVC SARANGE ?
            </h4>
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-start">
                ...
                <span className="text-sm text-slate-700 font-medium">
                  Suppression des courants d’air et du bruit
                </span>
              </div>
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-start">
              ...
              <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-start">
                ...
                <span className="text-sm text-slate-700 font-medium">
                  Valorisation durable de votre logement
                </span>
              </div>
            </div>
              ...
              <ul className="space-y-4">
                <li className="flex items-center group">
                  ...
                  <span className="text-slate-700 font-medium">
                    Profilés marque Schüco – Qualité Premium
                  </span>
                </li>
                <li className="flex items-center group">
                  <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mr-3 shrink-0 group-hover:bg-blue-100 transition-colors">
                  ...
                  <span className="text-slate-700 font-medium">
                    Renforts acier intégrés pour une rigidité optimale
                  </span>
                </li>
                <li className="flex items-center group">
                  <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mr-3 shrink-0 group-hover:bg-blue-100 transition-colors">
                  ...
                  <span className="text-slate-700 font-medium">
                    Double ou triple vitrage haute performance (Isolation A+)
                  </span>
                </li>
                <li className="flex items-center group">
                  <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mr-3 shrink-0 group-hover:bg-blue-100 transition-colors">
                ...
                <li className="flex items-center group">
                  ...
                  <span className="text-slate-700 font-medium">
                    Longévité accrue, même sur les grandes dimensions
                  </span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-blue-50/50 rounded-2xl p-5 flex items-start border border-blue-100/50">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Nos équipes assurent une pose en rénovation sans dégradation, précise et soignée,
                  garantissant la performance dans le temps de vos menuiseries.
                </p>
              </div>
            </div>
            ...
            <div className="bg-green-50 rounded-2xl p-5 flex items-start border border-green-100">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  <span className="px-2 py-1 bg-white text-green-700 border border-green-200 rounded text-[10px] font-bold uppercase">
                    RGE Qualibat
                  </span>
                  <span className="px-2 py-1 bg-white text-green-700 border border-green-200 rounded text-[10px] font-bold uppercase">
                    TVA 5.5%
