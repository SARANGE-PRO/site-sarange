                ...
                >
                    ...
                    <div className="bg-slate-900 text-white pt-10 pb-8 px-8 shrink-0 relative overflow-hidden">
                        ...
                        <p className="text-slate-300 text-sm mt-6 leading-relaxed max-w-2xl relative z-10">
                            Du garage simple au double, du neuf à la rénovation : chaque porte est fabriquée
                            sur-mesure. Performance thermique, sécurité renforcée et design personnalisé pour
                            valoriser votre habitation.
                        </p>
                    ...
                    <div
                        ref={contentRef}
                        className="px-8 py-8 overflow-y-auto custom-scrollbar flex-grow bg-slate-50/50"
                    >
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
                                    <div className="font-bold text-slate-800 mb-2 flex items-center">
                                        <div className="w-8 h-8 rounded-lg bg-orange-100 flex items-center justify-center text-orange-600 mr-2 group-hover:scale-110 transition-transform">
                                            1
                                        </div>
                                        Sectionnelle Plafond
                                    </div>
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        La plus répandue en France. Gain de place maximal, préserve les murs latéraux.
                                        Isolation thermique renforcée avec panneaux 40 ou 42 mm. Motorisable facilement.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
                                    ...
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        Coulisse latéralement le long du mur. Idéale pour plafond encombré ou faible
                                        hauteur. Permet un accès piéton partiel rapide sans ouverture complète.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
                                    ...
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        Gain d'espace total : plafond et murs libérés. Enroulement vertical dans un
                                        coffre aluminium compact. Solution moderne, discrète et performante en
                                        isolation.
                                    </p>
                                </div>
                                ...
                                <div className="bg-white p-5 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-shadow group">
                                    ...
                                    <p className="text-sm text-slate-600 leading-relaxed">
                                        Battante : ouverture à la française, charme authentique. Basculante : un seul
                                        panneau bascule vers le plafond. Solutions fiables, adaptées à la rénovation.
                                    </p>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <li className="bg-white p-3 rounded-xl border border-slate-100 flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <span className="text-xs text-slate-500">
                                                Seuil extra-plat PMR, accès rapide sans ouverture complète. Idéal pour
                                                vélos, poussettes ou usage quotidien.
                                            </span>
                                        </div>
                                    </li>
                                    <li className="bg-white p-3 rounded-xl border border-slate-100 flex items-start">
                                        ...
                                        <div>
                                            ...
                                            <span className="text-xs text-slate-500">
                                                Confort moderne : détection d'obstacles, pilotage smartphone, intégration
                                                domotique possible. Fiabilité et sécurité assurées.
                                            </span>
                                        </div>
                                    </li>
                                </ul>
