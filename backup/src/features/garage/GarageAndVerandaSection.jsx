...
import VerandaProductModal from '@features/garage/VerandaProductModal';
import GarageProductModal from '@features/garage/GarageProductModal';
    ...
    <section id="garage" className="py-24 bg-slate-50">
      ...
      <div className="container mx-auto px-4">
        <SectionTitle subtitle="Agrandir et protéger votre espace">
          Projets d'Envergure & Compléments
        </SectionTitle>
        <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="grid md:grid-cols-2 h-full">
              ...
              <div className="relative h-64 md:h-auto overflow-hidden">
                ...
                <div className="absolute bottom-6 left-6 text-white md:hidden">
                  <h3 className="text-2xl font-bold">Vérandas & Extensions</h3>
                </div>

                {/* Sceau Atelier */}
                <AtelierSeal className="absolute bottom-4 right-4 z-20 scale-75 md:scale-90" />
              ...
              <div className="p-8 flex flex-col justify-center">
                <div className="hidden md:block mb-4">
                  <div className="bg-green-100 text-green-700 p-2 rounded-lg inline-block mb-3">
                    <Home size={24} />
                  </div>
                  <h3 className="text-2xl font-bold text-slate-900">Vérandas & Extensions</h3>
                </div>
                <p className="text-lg font-semibold text-green-700 mb-4">
                  Plus qu'une véranda, une extension de votre maison.
                </p>
                <p className="text-slate-600 mb-6">
                  Ajoutez des m² habitables sans permis de construire. Valorisez votre patrimoine
                  avec une solution économique et rapide.
                </p>
                <div className="space-y-2 mb-8">
                  <div className="flex items-center text-sm text-slate-700">
                    <CheckCircle size={16} className="text-green-500 mr-2" /> Structure Aluminium
                    Schüco RE2020
                  </div>
                  <div className="flex items-center text-sm text-slate-700">
                    <CheckCircle size={16} className="text-green-500 mr-2" /> Toiture Isolante ou
                    Vitrée
                  </div>
                  <div className="flex items-center text-sm text-slate-700">
                    <CheckCircle size={16} className="text-green-500 mr-2" /> Plus-value immobilière
                    immédiate
                  </div>
                </div>
          ...
          >
            <div className="relative h-48 overflow-hidden shrink-0">
              ...
              <div className="absolute top-4 left-4 bg-orange-500 text-white px-3 py-1.5 rounded-full text-xs font-bold flex items-center shadow-lg z-20">
              ...
              {/* Sceau Atelier */}
              <AtelierSeal className="absolute bottom-3 right-3 z-20 scale-50" />
            ...
            <div className="p-8 flex flex-col h-full bg-slate-50/10 hover:bg-slate-50/50 transition-colors">
              ...
              <p className="text-slate-500 text-sm mb-6 flex-grow">
                100 % sur-mesure, motorisées. Sectionnelle, latérale, enroulable ou battante.
                Isolation renforcée et sécurité maximale.
              </p>
