                ...
                >
                    ...
                    <div className="bg-slate-900 text-white pt-8 pb-6 px-8 shrink-0 relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-300 text-sm mt-4 leading-relaxed max-w-lg">
                                Optez pour la finesse et la robustesse de l'aluminium. Idéal pour les grandes
                                ouvertures, il maximise l'apport de lumière naturelle tout en garantissant une
                    ...
                    <div className="px-8 py-6 overflow-y-auto space-y-8 custom-scrollbar">
                        ...
                        <h4 className="font-bold text-slate-900 text-lg -mb-2">
                            Pourquoi choisir l'Aluminium SARANGE ?
                        </h4>
                        <div className="grid sm:grid-cols-2 gap-4">
                            <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-start">
                                ...
                                <span className="text-sm text-slate-700 font-medium">
                                    Finesse des montants : Jusqu'à 20% de lumière en plus
                                </span>
                            </div>
                            <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-start">
                                <Maximize2 className="text-blue-500 mr-3 shrink-0" size={20} />
                                <span className="text-sm text-slate-700 font-medium">
                                    Grandes dimensions : Idéal pour les baies vitrées XXL
                                </span>
                            </div>
                            <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-start">
                                <ShieldCheck className="text-green-500 mr-3 shrink-0" size={20} />
                                <span className="text-sm text-slate-700 font-medium">
                                    Rigidité structurelle exceptionnelle (indéformable)
                                </span>
                            </div>
                            <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 flex items-start">
                                <Sparkles className="text-purple-500 mr-3 shrink-0" size={20} />
                                <span className="text-sm text-slate-700 font-medium">
                                    Entretien minimal et longévité maximale
                                </span>
                            </div>
                        </div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-start group">
                                    ...
                                    <span className="text-slate-700 font-medium">
                                        Liberté totale de couleurs (Nuancier RAL illimité)
                                    </span>
                                </li>
                                <li className="flex items-start group">
                                    <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center mr-3 shrink-0 shadow-sm">
                                    ...
                                    <span className="text-slate-700 font-medium">
                                        Bi-coloration possible (Couleur à l'extérieur / Blanc à l'intérieur)
                                    </span>
                                </li>
                                <li className="flex items-start group">
                                    <div className="w-6 h-6 rounded-full bg-white flex items-center justify-center mr-3 shrink-0 shadow-sm">
                                    ...
                                    <span className="text-slate-700 font-medium">
                                        Finitions variées : Brillant, Mat, Satiné ou Texturé (Granité/Sablé)
                                    </span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex items-center group">
                                    ...
                                    <span className="text-slate-700 font-medium">
                                        Profilés de marque Schüco (Leader mondial)
                                    </span>
                                </li>
                                <li className="flex items-center group">
                                    <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mr-3 shrink-0 group-hover:bg-blue-100 transition-colors">
                                    ...
                                    <span className="text-slate-700 font-medium">
                                        Rupture de Pont Thermique (RPT) complète (Conforme RE2020)
                                    </span>
                                </li>
                                <li className="flex items-center group">
                                    <div className="w-6 h-6 rounded-full bg-blue-50 flex items-center justify-center mr-3 shrink-0 group-hover:bg-blue-100 transition-colors">
                                    ...
                                    <span className="text-slate-700 font-medium">
                                        Sécurité renforcée (points de verrouillage multiples)
                                    </span>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-blue-50/50 rounded-2xl p-5 flex items-start border border-blue-100/50">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-slate-500 leading-relaxed">
                                    Nos équipes assurent une pose soignée et précise, adaptée aux spécificités de
                                    l'aluminium, garantissant une performance optimale et une longévité exceptionnelle
                                    de vos menuiseries.
                                </p>
                            </div>
                        </div>
