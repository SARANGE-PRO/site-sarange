        ...
        <section id="zone-intervention" className="py-24 bg-white">
            <div className="container mx-auto px-4">
                ...
                <p className="text-center text-xl text-slate-600 mb-12">
                    Basés à <strong>Combs-la-Ville (77380)</strong> en Seine-et-Marne, nous intervenons dans
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            {[
                                ...
                                <div
                                    key={dept.num}
                                    className="flex items-center bg-slate-50 p-3 rounded-lg border border-slate-200 hover:border-orange-400 transition-colors"
                                >
