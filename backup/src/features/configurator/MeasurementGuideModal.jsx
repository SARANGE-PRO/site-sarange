          ...
          {specificContent === 'cintrage' ? (
            <>
              <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center">
                <ArrowUpFromLine className="mr-2 text-orange-500" /> Mesurer une fenêtre cintrée
              </h3>
              <div className="space-y-4">
                ...
                <ul className="list-disc list-inside text-sm text-slate-600 space-y-1">
                  <li>
                    <strong>Largeur (Corde) :</strong> La largeur totale à la base du cintre.
                  </li>
                  <li>
                    <strong>Hauteur Droit :</strong> La hauteur de la partie verticale avant
                    l'arrondi.
                  </li>
                  <li>
                    <strong>Hauteur de Flèche :</strong> La distance entre la base et le point le
                    plus haut.
                  </li>
                </ul>
              </div>
            ...
            <>
              <h3 className="text-xl font-bold text-slate-900 mb-4 flex items-center">
                <Ruler className="mr-2 text-orange-500" /> Comment prendre vos mesures ?
              </h3>
              <div className="space-y-4">
                <div className="bg-blue-50 p-4 rounded-xl border border-blue-100">
                  <h4 className="font-bold text-blue-800 mb-2">La règle d'or : Mur à Mur</h4>
                  <p className="text-sm text-blue-700">
                    Mesurez la largeur et la hauteur du tableau (le trou dans le mur), à
                    l'intérieur.
                  </p>
                </div>
